...
from src.pose_estimation import calculate_distance, check_skeletons_in_frame, draw_skeleton
from src.trajectory_tracking import  remove_outliers, gaussian_smooth, update_trajectories, draw_gradient_line, draw_trajectories
from src.heatmap_generation import calculate_speeds, create_global_speed_matrix, generate_heatmap, overlay_heatmap
from src.utils import generate_colors, keypoint_dict, connections, reduce_frame_rate, check_negative_in_list
#from config import *
...
def main(cfg):
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            # Draw trajectories
            annotated_frame = draw_trajectories(annotated_frame, trajectories, generate_colors, check_negative_in_list, cfg.traj_radius)
